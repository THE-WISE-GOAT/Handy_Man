...
)  # this creates a CryptContext object that will be used to hash and verify passwords
...
def hash_password(password: str) -> str:
    return pwd_context.hash(
        password
    )  # this function takes a plain text password and returns a hashed version of the password using the CryptContext object we created


def verify_password(plain_password: str, hashed_password: str) -> bool:
    return pwd_context.verify(
        plain_password, hashed_password
    )  # this function takes a plain text password and a hashed password and returns a boolean indicating whether they match
