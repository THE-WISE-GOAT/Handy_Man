...
# from src.ai.customer_chat_analyser import (
#     build_fresh_history,
#     count_user_turns,
#     extract_final_json,
#     INITIAL_GREETING,
...
#     3. Calls Ollama with the full history so context is never lost.
...
#        whether it came from the static registry or the AI fallback.
...
#             detail=f"Ollama inference error: {exc}",
#         )

#     ai_message: str = response["message"]["content"].strip()
...
#             chat_session.problem_category    = structured.problem_category
#             chat_session.service_tags        = structured.service_tags
#             chat_session.problem_description = structured.problem_description
#             chat_session.is_job_request       = structured.is_job_request
#             chat_session.is_custom_category   = structured.is_custom_category

#             tags_to_return       = structured.service_tags
#             job_found            = structured.is_job_request
#             custom_category_flag = structured.is_custom_category
...
#             # Extraction itself failed (Ollama down, malformed JSON, etc.) —
...
#             chat_session.problem_category    = ""
#             chat_session.service_tags        = []
#             chat_session.problem_description = ""
#             chat_session.is_job_request       = False
#             chat_session.is_custom_category   = False
...
#     is_custom_category=True means the category/tags came from the AI
#     fallback rather than the static SERVICE_REGISTRY — route this to a
#     manual-matching / review flow instead of automated worker-tag matching.
...
#     return {
#         "problem_category":    chat_session.problem_category    or "unknown",
#         "service_tags":        chat_session.service_tags        or [],
#         "problem_description": chat_session.problem_description or "",
#         "is_complete":         chat_session.is_complete,
#         "is_job_request":      bool(chat_session.is_job_request),
#         "is_custom_category":  bool(chat_session.is_custom_category),
#     }