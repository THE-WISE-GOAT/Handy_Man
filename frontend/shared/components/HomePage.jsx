...
const serviceCards = [
  {
    ...
    description: 'Leaking taps, pipeline repair, structural maintenance and practical household fixes with disciplined field execution.',
    meta: 'Built for repeatable repair work'
  },
  {
    tag: 'Safety Scan',
    title: 'Electrical & Infrastructure Audits',
    description: 'Safety inspection, circuit wiring, EV charging setups and preventative checks for homes under active use.',
    meta: 'Inspection-first service flow'
  },
  {
    tag: 'Connected Living',
    title: 'Smart Home & IoT Deployment',
    description: 'CCTV installation, home networking, router configuration and low-friction smart-device deployment.',
    meta: 'Network-ready service packaging'
  },
  {
    tag: 'Emergency Dispatch',
    title: 'Urgent Care Dispatch',
    description: 'Fast-response repair routing with a two-hour emergency repair window for critical home issues.',
    ...
    <div className="ind-page">
      <header className="ind-topbar">
        <div className="ind-container ind-topbar__inner">
          <a className="ind-brand" href="#home" onClick={(event) => event.preventDefault()}>
        ...
        <div className="ind-container hero-grid">
          <div className="hero-copy">
            ...
            <p className="ind-hero__lede">
              A structured local services platform for repairs, installations, and urgent field support. Search by need, route to the right trade, and move from request to resolution without friction.
            </p>
            ...
            <div className="hero-stats" aria-label="Platform highlights">
              ...
              <div className="hero-stat">
                ...
                <span className="hero-stat__label">Verified technician pool</span>
              </div>
              <div className="hero-stat">
          ...
          <aside className="hero-panel">
            ...
            <form className="hero-search" onSubmit={handleSearchSubmit}>
              <label className="hero-search__field" htmlFor="service-search">
                <span className="hero-search__label">What service do you require?</span>
                <input
                  id="service-search"
              ...
              <div className="hero-search__actions">
                <button className="ind-primary-button" type="submit">Find Technicians</button>
                <span className="hero-search__hint">Fast matching for household repair and install requests.</span>
              </div>
            </form>
      ...
      <section className="ind-grid-section" id="services">
        <div className="ind-container">
          <div className="ind-grid-header">
            ...
            <p>
              A four-box service matrix designed for quick scanning, clear job scope definition, and efficient response routing.
            </p>
          </div>
        ...
        <div className="ind-container">
          <div className="ind-trust-banner">
            <div className="ind-trust-item">
              ...
              <span>Local, accountable, and trade-focused dispatch network.</span>
            </div>
            <div className="ind-trust-item">
              <strong>30-Day Work Warranty</strong>
              <span>Clear post-job coverage for eligible service categories.</span>
            </div>
            <div className="ind-trust-item">
              <strong>Upfront Transparent Pricing</strong>
              <span>Cost framing before work begins, no hidden structural surprises.</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="ind-footer">
        <div className="ind-container ind-footer__bar">
          ...
          <span>Industrial technical layout built for local home service operations.</span>
        </div>
      </footer>
    </div>
  );
